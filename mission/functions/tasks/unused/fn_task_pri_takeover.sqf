...
_taskDataStore setVariable ["defeat_hostile_forces", {
	...
	private _playersInZone = {alive _x and side _x == independent} count (allUnits inAreaArray _zone);
	private _enemyInZone = {alive _x and side _x == west} count (allUnits inAreaArray _zone);
